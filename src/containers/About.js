...
import Schema from "../containers/assets/images/schemaArchi.png"
    ...
    <div className='mt-[300px]'>
      <div className='lg:flex'>
        ...
        <div className='backdrop-blur-sm bg-white/10 border rounded-lg w-11/12 mx-auto m-2 p-2 text-justify'>
          <p>Dans le cadre de la validation du titre professionnel Concepteur
            ...
            <img className='my-10' src={Schema} alt='schema_architecture'/>
            <p>AWS a été utilisé pour créer une fonction Lambda écrite en python,
