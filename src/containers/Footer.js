...
const Footer = ({token}) => {
  return (
    <section className="footer h-[515px] lg:h-[420px] xm:h-[415px] w-full xl:h-[480px]  md:h-[760px] xls:h-[440px] bg-black/70 bottom-0">
    <div className="w-full xlx:w-[930px] md:w-2/3 sm:mx-auto flex flex-wrap justify-evenly pt-20">
      ...
      <div className="text-white flex max-md:flex-col sm:mb-10">
        ...
        <ul className="">
          <li className="font-semibold relative md:-left-2 lg:right-9">Autre réalisation</li>
